...
function  [dxO2, dxCO2, dWh, internal_variables_] = coronary_and_resting_muscle_blood_flow(t, y, pars, internal_variables)
    ...
    MO2_p(1) = MO2_h_p;
    vO2 = aO2 - MO2_p ./ Q_p;   %vectorial   '''creo que estÃ¡ correcto porque por balance de flujos se tiene que expresar asÃ­: vo2 * Q - aO2 * Q = MO2p --> sale/t - entra/t = consumo/t. Si fuera la derivada del flujo ademÃ¡s aparecerÃ­a un segundo extra en el denominador
