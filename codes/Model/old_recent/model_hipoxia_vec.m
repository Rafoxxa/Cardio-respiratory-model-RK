...
function [y_, internal_variables_, test_] = neuromuscular_drive(t, y, pars, internal_variables, index, tiny_y_keys, test)
    ...
    internal_variables(98) = Nt;  %dejar derivada en 0 y guardar todas las variables externas en una 
    internal_variables_ = internal_variables; 
    y_ = y;
    test_ = test;
...
function [dv, dMRtgas, test_] = tissue(t, y, pars, test)
    ...
    function pars_ = input_consumption(t, y, pars)
        ...
        if type_of_input == 1 %testing_simulation
            ...
            if t < 66
                %barely basal
                MRO2 = MRtO2_basal; %0.02 + MRtO2_basal; %10 * MRtO2_basal;
                MRCO2 = MRtCO2_basal; %0.02 + MRtCO2_basal; %10 * MRtCO2_basal;
                %MRO2 = 1.183;
                %MRCO2 = 1.08;
            end
...
function [internal_variables_,  dzheta_heart, dV_total_rv, dV_total_ra, dV_total_la, dV_total_lv, dQla, dTheart, test_] = heart(t, y, pars, internal_variables, test)
    ...
    %------------------------------------
    %internal_variables
    Theart = internal_variables(131);
    Ptor = internal_variables(35);  
    Q_ra = internal_variables(44);
    P_ra = internal_variables(19);
    E_max_lv = internal_variables(129);
    E_max_rv = internal_variables(130);
    if t == 0
        E_max_lv = y(89);
        E_max_rv = y(90);
    end
    ...
    % Saving computations
        ...
        internal_variables(83) = Wh_lv;
        internal_variables(84) = Wh_rv;
        internal_variables_ = internal_variables;
...
function [internal_variables_, dV_total_vc, dV_total_v, dP_sp, dQbp, test_] = systemic_peripheric_and_venous_circulation(t, y, pars, internal_variables, test)
    ...
    R_e_p = internal_variables(136);
    R_s_p = internal_variables(137);
    R_b_p = internal_variables(135);
    R_h_p = internal_variables(133);
    R_rm_p = internal_variables(134);
    R_am_p = internal_variables(132);

    V_unstressed_e_v = internal_variables(125);
    V_unstressed_s_v = internal_variables(126);
    V_unstressed_rm_v = internal_variables(127);
    V_unstressed_am_v = internal_variables(128);
    ...
    %Saving computations    
    internal_variables(90) = Q_p(6);
    internal_variables(85) = Q_p(4);
    internal_variables(86) = Q_p(5);
    internal_variables(73) = Q_p(3);
    internal_variables(77) = Q_p(1);
    internal_variables(78) = Q_p(2);
    internal_variables_ = internal_variables;
    test_ = test;
end
...
function [dxO2_e, dxO2_s, dxO2_p, internal_variables_] = hipoxia_local_regulation(t, y, pars, internal_variables) 
    ...
    R_e_p_n = internal_variables(121);
    R_s_p_n = internal_variables(122);
    ...
    %internal variables
    Q_e_p = internal_variables(77);
    Q_s_p = internal_variables(78);
    ...
    internal_variables(136) = R_ep;
    internal_variables(137) = R_sp;
    internal_variables(138) = R_pp;
...
function  [dxO2, dxCO2, dWh, internal_variables_] = coronary_and_resting_muscle_blood_flow(t, y, pars, internal_variables)
    ...
    R_rm_p_n = internal_variables(123);   
    tau_w = pars(187);   
    tau_O2 = pars(177);
    tau_CO2 = pars(176);
    Whn = pars(188); 
    ...
    %internal variables
    Wh_lv = internal_variables(83);
    Wh_rv = internal_variables(84);
    Q_h_p = internal_variables(85);
    Q_rm_p = internal_variables(86);
    Q_p = [Q_h_p, Q_rm_p];
    ...
    internal_variables(133) = Rp(1);
    internal_variables(134) = Rp(2);
    internal_variables_ = internal_variables;
...
function [dxO2_am, dx_met, dx_M, dphi_met, internal_variables_] = active_muscle_blood_flow(t,y,pars, internal_variables, index_fun)
    ...
    %internal variables
    I = internal_variables(96);
    Q_am_p = internal_variables(90);
    %Equations
    R_amp_n = internal_variables(124);
...
function [dDThetaO2_s, dDThetaCO2_s, internal_variables_] = cns_ischemic_response(t, y, pars, internal_variables)
     ...
     internal_variables(99) = Theta_s(1);
     internal_variables(100) = Theta_s(2);
     internal_variables(101) = Theta_s(3);
...
function [internal_variables_] = efferent_pathways(t, y, pars, internal_variables)
    ...
    %internal variables
    I = internal_variables(96);
    fab = internal_variables(97);
    Nt = internal_variables(98);    
    
    Theta_h_s = internal_variables(99);
    Theta_p_s = internal_variables(100);
    Theta_v_s = internal_variables(101);
    ...
    %internal variables
    internal_variables(119) = fs(1);
    internal_variables(107) = fs(2);
    internal_variables(108) = fs(3);
    internal_variables(120) = fv;
...
function [dDTheta, dfh_s, dfp_s, dfv_s, internal_variables_] = reflex_control_R_Vu_E(t, y, pars, internal_variables, index_fun)
    ...
    %internal variables
    f_h_s_actual = internal_variables(119);  
    f_p_s_actual = internal_variables(107);
    f_v_s_actual = internal_variables(108);
    ...
    internal_variables(136) = Theta(1);
    internal_variables(137) = Theta(2);
    internal_variables(123) = Theta(3);
    internal_variables(124) = Theta(4);
    internal_variables(125) = Theta(5);
    internal_variables(126) = Theta(6);
    internal_variables(127) = Theta(7);
    internal_variables(128) = Theta(8);
    internal_variables(129) = Theta(9);
    internal_variables(130) = Theta(10);
...
function [dDTsym, dDTvagal, dfv, internal_variables_] = reflex_control_HR(t, y, pars, internal_variables, index_fun)
    ...
    %internal variables
    f_h_s_actual = internal_variables(119);
    f_v_actual = internal_variables(120);
...
function [internal_variables_] = adding_base_values_in_control_variables(t, y, pars, internal_variables)
    ...
    internal_variables(121) = R_e_p_n;
    internal_variables(122) = R_s_p_n;
    internal_variables(123) = R_rm_p_n;
    internal_variables(124) = R_am_p_n;
    internal_variables(125) = Theta(5);
    internal_variables(126) = Theta(6);
    internal_variables(127) = Theta(7);
    internal_variables(128) = Theta(8);
    internal_variables(129) = Theta(9);
    internal_variables(130) = Theta(10);
    internal_variables(131) = Theart;    
    internal_variables(132) = R_am_p;
    internal_variables(133) = Rp(1);
    internal_variables(134) = Rp(2);
    internal_variables(135) = R_bp;
    %HIPOXIA
    internal_variables(136) = R_ep;
    internal_variables(137) = R_sp;
    internal_variables(138) = R_pp_;
