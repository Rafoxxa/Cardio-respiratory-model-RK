...
PARS = pars;   
    ...
    function J = cost_fun(cycle, OPTIONS, PARS, args)
        ...
        optim_pars = PARS;
        optim_pars(344) = args(1);
        optim_pars(345) = args(2);
        optim_pars(346) = 0;  %fixed by authors
        optim_pars(347) = args(3);
        optim_pars(348) = args(4);
        optim_pars(349) = args(5);
        
        optim_pars(350) = optim_pars(344) + optim_pars(345);
    ...
    function args_optimal = control_optimization(cycle, OPTIONS, PARS, dVE)
        ...
        lb = [pars(334), pars(335), pars(336), pars(337), pars(338)];
        ub = [pars(339), pars(340), pars(341), pars(342), pars(343)];
