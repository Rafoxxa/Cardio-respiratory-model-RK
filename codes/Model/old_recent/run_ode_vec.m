...
PARS = pars;   
    ...
    function J = cost_fun(cycle, OPTIONS, PARS, args)
        ...
        optim_pars = PARS;
        optim_pars(334) = args(1);
        optim_pars(335) = args(2);
        optim_pars(336) = 0;  %fixed by authors
        optim_pars(337) = args(3);
        optim_pars(338) = args(4);
        optim_pars(339) = args(5);
        
        optim_pars(340) = optim_pars(334) + optim_pars(335);
    ...
    function args_optimal = control_optimization(cycle, OPTIONS, PARS, dVE)
        ...
        lb = [pars(324), pars(325), pars(326), pars(327), pars(328)];
        ub = [pars(329), pars(330), pars(331), pars(332), pars(333)];
