...
PARS = pars;   
    ...
    function J = cost_fun(cycle, OPTIONS, PARS, args)
        ...
        optim_pars = PARS;
        optim_pars(349) = args(1);
        optim_pars(350) = args(2);
        optim_pars(351) = 0;  %fixed by authors
        optim_pars(352) = args(3);
        optim_pars(353) = args(4);
        optim_pars(354) = args(5);
        
        optim_pars(355) = optim_pars(349) + optim_pars(350);
        ...
        function J = respiratory_work(state_vars, OPTIONS, optim_pars)
            ...
            TI_check = var_inside_boundries(TI, optim_pars(344), optim_pars(339));
            TE_check = var_inside_boundries(TE, optim_pars(345), optim_pars(340)); 
            a1_check = var_inside_boundries(a1, optim_pars(346), optim_pars(341));
            a2_check = var_inside_boundries(a2, optim_pars(347), optim_pars(342));
            tau_check = var_inside_boundries(tau, optim_pars(348), optim_pars(343));
    ...
    function args_optimal = control_optimization(cycle, OPTIONS, PARS, dVE)
        ...
        lb = [pars(339), pars(340), pars(341), pars(342), pars(343)];
        ub = [pars(344), pars(345), pars(346), pars(347), pars(348)];
        ...
        function [c, ceq] = ventilation_constraint(args, dVE, PARS, OPTIONS)
            ...
            TI_check = var_inside_boundries(TI, PARS(344), PARS(339));
            TE_check = var_inside_boundries(TE, PARS(345), PARS(340));
            a1_check = var_inside_boundries(a1, PARS(346), PARS(341));
            a2_check = var_inside_boundries(a2, PARS(347), PARS(342));
