function parameter_analysis_plot(p, plot_type, thresh)
    ...
    if plot_type == "all"
        custom_plot("LSA-plot", {sens_matrix, pars_to_sens, setup.variables_of_interest, setup.idx_variable_of_interest, p});
    end
    
    
    
    % % Apply sensitivity threshold
    sens_threshold = thresh;
    ...
    if plot_type == "after-thresh"
        custom_plot("LSA-plot", {sens_reduced, pars_to_sens_reduced,setup.variables_of_interest, idx_variable_of_interest, p});
    end
    ...
    if plot_type == "reduced-pars"
        custom_plot("LSA-plot", {sens_matrix_filtered, pars_to_sens_filtered, setup.variables_of_interest, idx_variable_of_interest, p});
    end
    % 
